/*
	 ...
	 Example of: http://whatizee.blogspot.com.co/2015/02/nodejs-kafka-producer-using-kafka-node.html
 */
 ...
 var kafka = require('kafka-node'),
     ...
     client = new kafka.Client('192.168.90.30:2181'),
     ...
     */
     payloads = [
         { topic: 'my-topic-test', messages: 'This is the First Message I am sending', partition: 0 },
     ];
